...
class AdminChatPageScreen extends StatefulWidget {
  ...
  @override
  State<AdminChatPageScreen> createState() => _AdminChatPageState();
}

class _AdminChatPageState extends State<AdminChatPageScreen> {
  ...
  void _sendMessage() async {
    ...
    await _chatService.sendMessage(text, ChatAdminService.adminId);
  ...
  Future<void> _sendImage() async {
    ...
    if (picked != null) {
      await _chatService.sendImage(File(picked.path), ChatAdminService.adminId);
      _scrollToBottom();
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final bool isAdmin = UserSession.instance.userId == ChatAdminService.adminId;
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          Expanded(
            child: StreamBuilder(
              stream: _chatService.getMessages(ChatAdminService.adminId),
