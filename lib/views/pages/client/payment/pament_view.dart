...
import 'package:recomart/config/color.dart'; // Giả định AppColors.primary là màu xanh dương
...
class _PaymentViewState extends State<PaymentView> {
  ...
  Future<void> handleCreateOrder() async {
    ...
    // Thay đổi AlertDialog thành dialog hiện đại hơn
    showDialog(
      context: context,
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Your order has been placed successfully. We are preparing your tech!',
                  ...
                  ? MyButton(
                      ...
                      onTap: (_) {
                        ...
                        Navigator.of(context)
                            .pushReplacementNamed('order-view');
                      },
                    )
                  : Column(
                      children: [
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: Colors.grey.shade50, // Nền xám nhẹ cho cảm giác hiện đại
          ...
          builder: (context, snapshot) {
            ...
            return Consumer<CartProvider>(
              builder: (context, cartProvider, _) {
                ...
                return Container(
                  color: Colors.grey.shade50, // Nền xám nhẹ
      ...
      bottomNavigationBar: isMobile
          ? Container(
              padding: const EdgeInsets.only(
                  left: 24, right: 24, bottom: 32, top: 20), // Tăng padding dưới
              decoration: BoxDecoration(
                color: Colors.white,
                boxShadow: [
                  BoxShadow(
                    color: AppColors.primary.withOpacity(0.2), // Shadow màu xanh
                    blurRadius: 15,
              ...
              child: Row(
                ...
                children: [
                  ...
                  // Nút thanh toán - Dùng MyButton đã có
                  SizedBox(
                    height: 50, // Chiều cao nút lớn hơn
