          ...
          children: [
            Card(
              ...
              child: ListTile(
                ...
                subtitle: Text('${widget.quantity} x ${format(widget.unitPrice ?? 0)} VND'),
                trailing: Text('${format(subtotal)} VND', style: const TextStyle(color: AppColors.primary, fontWeight: FontWeight.bold)),
              ),
            ),
