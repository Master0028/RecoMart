...
class _ProductVariantFormState extends State<ProductVariantForm> {
  ...
  void dispose() {
    ...
    variantColorController.dispose();
    variantDescriptionController.dispose();
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  final variantData = {
                    ...
                    if (widget.initialVariant != null && widget.initialVariant!['_id'] != null) '_id': widget.initialVariant!['_id'],
                  };
