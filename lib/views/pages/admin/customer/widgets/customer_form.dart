              ...
              child: Column(
                ...
                children: [
                  if (widget.visibleFields.contains('fullName')) ...[
                    ...
                    Text(widget.initialCustomer?['name'] ?? 'N/A'),
                  ...
                  if (widget.visibleFields.contains('phone')) ...[
                    ...
                    const SizedBox(height: 8),
                    Text(widget.initialCustomer?['phone'] ?? 'N/A'),
                    const SizedBox(height: 20),
                  ],
                  if (widget.visibleFields.contains('email')) ...[
                    ...
                    const SizedBox(height: 8),
                    Text(widget.initialCustomer?['email'] ?? 'N/A'),
                    const SizedBox(height: 20),
                  ],
                  if (widget.visibleFields.contains('address')) ...[
                    ...
                    const SizedBox(height: 8),
                    Text(widget.initialCustomer?['address'] ?? 'N/A'),
                    const SizedBox(height: 20),
                  ],
                      ...
                      Expanded(
                        child: ElevatedButton(
                          onPressed: () {
                            ...
                            if (widget.visibleFields.contains('isActive')) {
                              customerData['status'] = isDisabled ? 'Disabled' : 'Active';
                            }
